...
> [Insights](https://github.com/Afokoghene/Inc-5000-Companies-2019/#insights) <br>
...
1. From the dataset, it can be seen that companies on the Inc 5000 List make an average revenue of $47million. 

2. Looking at the average revenue by industry, security can be seen to generate an average revenue of approximately $124million but this doesn’t mean it contributed the most percentage to the total revenue as it is seen to contribute just about 3.48% of the total revenue. 

3. The Health industry is seen to have an average revenue of $109million and a percentage total of revenue being 16.35. This means the health industry contributes the highest part to the total revenue generated and it also has the second highest average revenue generated. 

4. Business Products and Services industry is seen to have the most companies with 492 companies in it. This industry contributes 5.91% to the total revenue generated by industries on the list. Advertising & Marketing industry follows with the most companies with 489 companies and contributing 3.88 to the total revenue generated by industries. 

5. It is seen that the Computer Hardware industry has the least number of companies, with a total of 32 companies. This industry contributes 0.41% to the total revenue generated by industries on the list. 

6. With 712 companies located in California, it is the state with the most companies on the list. Companies in California are seen to generate an average revenue of $53million. Although California does not have the highest average revenue when compared to states like Minnesota, it can be seen that it contributes the most to the total revenue with a percentage total of 15.90%.

7. Minnesota is seen to have an average of $286mllion, this makes it have the highest average revenue amongst other states. It is seen to also contribute 9.72% revenue to the total revenue even though it has just 81 companies located in it. 

8. Texas with 467 companies is the state with the second highest companies located in it. Texas is seen to contribute 8.41% to the total revenue generated by states. 

9. The cities of New York, Chicago and Atlanta are send to have the highest number of companies located in them with 165, 110 ans 101 companies respectively. 

10. Logistics & Transportation industry saw the largest growth rate with an average of 717.6%, this is followed Consumer Products & Services with an average growth rate of 685.6

11. The company with the highest increase in workers is Allied Universal with an increase of 118,531. Allied Universal is followed by Alorica with a 43,000 increase in workers. 

12. Freestar, FreightWise and Cece's Veggie Co. are seen to have the top 3 highest growth rate for the period with growth rates of 36,680.39%, 30,547.93%, 23,880.49% respectively. 

13. Correlation analysis for workers and revenue: It was found out that there is a positive correlation of 0.27 between the revenue and total number of workers in a company. This indicates that as the number of workers increase, the revenue generated also increases, though this is a relatively weak positive correlation. Though there is a relationship between the two variables, it’s very possible that other factors or variables do affect the revenue generated too. 

14. Correlation analysis for years on the list and growth rate: It was found out that there is a weak negative correlation of -0.16 between the number of years company has been on the list and its growth rate. This means that as the number of years a company has been on the list increases, it’s growth rate tends to decrease slightly but not strongly as this is a really weak relationship.

---

Big THANKS again if you did read till this spot, I appreciate the time taken out to go through the project. I know it was almost overwhelming, I was trying to be as detailed as possible. 
To connect with me, follow me on [Twitter](https://twitter.com/__afoke?t=_YX2DAel3R3aWZGDvSEZ9w&s=09), LinkedIn still in progress.
